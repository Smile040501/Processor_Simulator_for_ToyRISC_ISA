...
public class Instruction {
	...
	public enum OperationType {
		add, addi, sub, subi, mul, muli, div, divi, and, andi, or, ori, xor, xori, slt, slti, sll, slli, srl, srli, sra, srai, load, store, jmp, beq, bne, blt, bgt, end
	};
		...
		if (sourceOperand1 != null) {
			if (sourceOperand2 != null) {
				if (destinationOperand != null) {
					return "PC=" + programCounter + "\t" + operationType + "\t" + sourceOperand1
							+ "\t" + sourceOperand2 + "\t" + destinationOperand + "\n";
				} else {
					return "PC=" + programCounter + "\t" + operationType + "\t" + sourceOperand1
							+ "\t" + sourceOperand2 + "\tnull" + "\n";
				}
			...
			if (sourceOperand2 != null) {
				if (destinationOperand != null) {
					return "PC=" + programCounter + "\t" + operationType + "\tnull" + "\t"
							+ sourceOperand2 + "\t" + destinationOperand + "\n";
				} else {
					return "PC=" + programCounter + "\t" + operationType + "\tnull" + "\t"
							+ sourceOperand2 + "\tnull" + "\n";
				...
				if (destinationOperand != null) {
					return "PC=" + programCounter + "\t" + operationType + "\tnull" + "\tnull"
							+ "\t" + destinationOperand + "\n";
				} else {
					return "PC=" + programCounter + "\t" + operationType + "\tnull" + "\tnull"
							+ "\tnull" + "\n";
