...
print("Students :\t" + zip_file.split("/")
      [l-1].split("_")[0] + " and " + zip_file.split("_")[1].split(".")[0])
print("")
...
for testcase in os.listdir(test_cases_dir):
    if ".asm" in testcase:
        ...
        stdout_file = open("./tmp.output", 'a')
        popen_args = ["java", "-Xmx1g", "-jar", "jars/assembler.jar", test_cases_dir +
                      "/" + testcase, "./" + testcase.split(".")[0] + ".observedoutput"]
