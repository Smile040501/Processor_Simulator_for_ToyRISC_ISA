...
public class Configuration {
	...
	public static void parseConfigurationFile(String configFileName) {
		Document doc = null;
		...
		ALU_reciprocal_of_throughput =
				Integer.parseInt(getImmediateString("ReciprocalOfThroughput", elmnt));
		...
		multiplier_reciprocal_of_throughput =
				Integer.parseInt(getImmediateString("ReciprocalOfThroughput", elmnt));
		...
		divider_reciprocal_of_throughput =
				Integer.parseInt(getImmediateString("ReciprocalOfThroughput", elmnt));
																				...
																				// tag
	{
		...
		if (nodeLst.item(0) == null) {
			Misc.printErrorAndExit(
					"XML Configuration error : Item \"" + tagName + "\" not found inside the \""
